...
//Variveis Estaticas
Static cTitulo := "Cadastro de CDs (com número máximo de linhas)"
Static cTabPai := "ZD2"
Static cTabFilho := "ZD3"

/*/{Protheus.doc} User Function zMVC28
CDs
...
Menu de opcoes na funcao zMVC28
@author Daniel Atilio
@since 21/01/2022
@version 1.0
@type function
...
Static Function MenuDef()
	...
	ADD OPTION aRotina TITLE "Visualizar" ACTION "VIEWDEF.zMVC28" OPERATION 1 ACCESS 0
	ADD OPTION aRotina TITLE "Incluir" ACTION "VIEWDEF.zMVC28" OPERATION 3 ACCESS 0
	ADD OPTION aRotina TITLE "Alterar" ACTION "VIEWDEF.zMVC28" OPERATION 4 ACCESS 0
	ADD OPTION aRotina TITLE "Excluir" ACTION "VIEWDEF.zMVC28" OPERATION 5 ACCESS 0

Return aRotina

/*/{Protheus.doc} ModelDef
Modelo de dados na funcao zMVC28
@author Daniel Atilio
@since 21/01/2022
@version 1.0
@type function
...
Static Function ModelDef()
	...
	oModel := MPFormModel():New("zMVC28M", bPre, bPos, bCommit, bCancel)
...
Visualizacao de dados na funcao zMVC28
@author Daniel Atilio
@since 21/01/2022
@version 1.0
@type function
...
Static Function ViewDef()
	Local oModel := FWLoadModel("zMVC28")
