...
//Variveis Estaticas
Static cTitulo := "Cadastro de CDs (sem repetição de informações na grid)"
Static cTabPai := "ZD2"
Static cTabFilho := "ZD3"

/*/{Protheus.doc} User Function zMVC29
CDs
...
Menu de opcoes na funcao zMVC29
@author Daniel Atilio
@since 21/01/2022
@version 1.0
@type function
...
Static Function MenuDef()
	...
	ADD OPTION aRotina TITLE "Visualizar" ACTION "VIEWDEF.zMVC29" OPERATION 1 ACCESS 0
	ADD OPTION aRotina TITLE "Incluir" ACTION "VIEWDEF.zMVC29" OPERATION 3 ACCESS 0
	ADD OPTION aRotina TITLE "Alterar" ACTION "VIEWDEF.zMVC29" OPERATION 4 ACCESS 0
	ADD OPTION aRotina TITLE "Excluir" ACTION "VIEWDEF.zMVC29" OPERATION 5 ACCESS 0

Return aRotina

/*/{Protheus.doc} ModelDef
Modelo de dados na funcao zMVC29
@author Daniel Atilio
@since 21/01/2022
@version 1.0
@type function
...
Static Function ModelDef()
	...
	oModel := MPFormModel():New("zMVC29M", bPre, bPos, bCommit, bCancel)
...
Visualizacao de dados na funcao zMVC29
@author Daniel Atilio
@since 21/01/2022
@version 1.0
@type function
...
Static Function ViewDef()
	Local oModel := FWLoadModel("zMVC29")
