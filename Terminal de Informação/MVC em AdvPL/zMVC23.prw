...
Cadastro de Artistas (com opção de exibir ou não os detalhes do registro posicionado)
...
User Function zMVC23()
    ...
    If FWAlertYesNo("Você gostaria de exibir os detalhes do registro posicionado?", "Confirma?")
